        ...
        public async Task<SesionDTO> Autorizacion(LoginDTO modelo)
        {
            try
            {
                ...
                if(fromDbModelo != null)
                    // se usa para que fromDbModelo esta variable sea covertida en un modelo SesionDTO
                    return _mapper.Map<SesionDTO>(fromDbModelo);
                else
                    throw new TaskCanceledException("No se encuentraron coincidencias");  
            }
            catch(Exception ex) 
            {
                throw ex;
        ...
        public async Task<UsuarioDTO> Obtener(int id)
        {
            try
            {
                ...
                if (fromDbModelo != null)
                    ...
                    throw new TaskCanceledException("No se encotraron resultados");
